...
- 鎮圧作業。手のひらなどでプレスすることで培地と種を密着させ、発芽しやすくする。
- 水位は2～3cmをキープ。

### バケツ

- 雨が降った時に排水されるように、はんだごてなどを使ってバケツの横に穴をあける。
    - オクラの方もやった方がいいのかな…？

![バケツに穴開け](./cucumber_media/bucket_hole1.png)
![バケツに穴開け](./cucumber_media/bucket_hole2.png)
